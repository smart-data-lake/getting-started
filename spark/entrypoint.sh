...
java $JAVA_OPTIONS -Duser.dir=/mnt/data -Dlog4j2.configurationFile=file:/opt/app/lib/log4j2.yml -cp /opt/app/lib/*:/mnt/lib/* io.smartdatalake.app.LocalSmartDataLakeBuilder $@
